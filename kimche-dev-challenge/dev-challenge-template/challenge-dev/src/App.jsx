  ...
  if (loading) {
    return (
      <div>
        ...
        <iframe
          src="https://giphy.com/embed/vFtGDTXTNr4Z3uG4St"
          alt="Loading"
          width="100%"
        />
      </div>
      ...
      {characters.length > 0 && detalleVisible && (
        <div className="modal" onClick={cerrarDetalle}>
          <div className="modalContent" onClick={(e) => e.stopPropagation()}>
            <span className="close" onClick={cerrarDetalle}>
              X
            </span>
            <div className="modalImage">
              <img
                src={characters[detalleIndex].image}
                alt={characters[detalleIndex].name}
              />
            </div>
            <div className="info">
...
App.propTypes = {
  ...
  detalleVisible: PropTypes.bool.isRequired,
  detalleIndex: PropTypes.number.isRequired,
  inputSearch: PropTypes.string.isRequired,
  searchTerm: PropTypes.string.isRequired,
  allSpecies: PropTypes.array.isRequired,
  changedFilters: PropTypes.bool.isRequired,
